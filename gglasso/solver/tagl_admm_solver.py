...
def admm_tagl(S, A, p, T, lam1, lam2, rho, t, Om0, Gam0, Atilde, A_for_gamma, A_for_B, C, C_for_D, stat, eps_abs, eps_rel=1e-3):
...
def la_admm_tagl(S, A, p, T, lam1, lam2, rho, t, K, eps_abs, eps_rel=1e-3):
    ...
    stat = 0
    for l in range(K):
        Om, Gam, D = admm_tagl(S, A, p, T, lam1, lam2, rho, t, Om, Gam, Atilde, A_for_gamma, A_for_B, C, C_for_D, stat, eps_abs, eps_rel)
